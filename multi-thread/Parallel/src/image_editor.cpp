...
{
    filterPipe_.push_back(new ParallelFlipFilter());
    filterPipe_.push_back(new ParallelBlurFilter());
    filterPipe_.push_back(new ParallelPurpleHazeFilter());
    filterPipe_.push_back(new ParallelLineFilter());
}
